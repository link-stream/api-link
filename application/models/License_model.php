...
class License_model extends CI_Model {
    ...
    public function fetch_licenses() {
        $this->db->from('st_license');
        $query = $this->db->get();
    ...
    public function fetch_licenses_by_user_id($user_id, $license_id) {
    ...
    public function insert_license($data) {
        $this->db->insert('st_user_license', $data);
...
//    }
    ...
    public function insert_item_license($data) {
        $this->db->insert('st_user_invoice_license', $data);
        return $this->db->insert_id();
    }
