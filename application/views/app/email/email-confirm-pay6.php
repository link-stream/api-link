                ...
                <td class="container" style="font-family: sans-serif;font-size: 14px;vertical-align: top;line-height: 20px;display: block;max-width: 620px;width: 620px;margin: 0 auto !important;">
                    ...
                    <div align="center">
                        ...
                        <div class="row" style="margin-top: 10px; display: flex; justify-content:center">                  
                            ...
                            <div class="col" style="margin-top: 10px; margin-rigth: 10px; margin-left: 5px;">


                                <div class="card card-summary" align="center">



                                    <div class="row px-4 py-4" style="padding-top: 5px; padding-left: 5px;" align="center">
                            ...
                            <div class="col" style="margin-top: 10px; margin-left: 10px; margin-bottom: 5px;" align="left">
                                ...
                                <div class="card-summary">
                                    ...
                                    <div style="margin-left: 6px; padding-top: 7px; margin-right: 5px;">
                                        ...
                                        <div class="row" style="margin-top: 5px;">
                                            ...
                                            <div class="col" align="right" style="width: 65px;">
                                ...
                                <div class="card-summary" style="margin-top: 10px;">
                                    ...
                                    <div style="margin-left: 6px; padding-top: 7px;">
                                        ...
                                        <div class="row">
                                            ...
                                            <span class="card-summary-title"> Customer Information</span>
                                        ...
                                        <div class="row" style="margin-top: 1px;">
                                            ...
                                            <div class="col">
                                                ...
                                                <img src="<?= (!empty($cc)) ? $cc : 'https://dev-link-vue.link.stream/static/img/visa.svg' ?>" style="width:30px; height:25px;">
                    ...
                    <div align="center">
                        ...
                        <div class="instagram" style="width:600px;">
