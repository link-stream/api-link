...
//        FILTER_SANITIZE_URL);
$redirect = filter_var('http://localhost/api.link.stream/app/youtube_upload_image',
        FILTER_SANITIZE_URL);
...
if ($client->getAccessToken()) {
    ...
    try {
        ...
        $imagePath = $this->temp_dir . '/' . $file_name;
...
<html>
    <head>
        <title>Youtube Video Update</title>
    </head>
    <body>
        <?= $htmlBody ?>
    </body>
